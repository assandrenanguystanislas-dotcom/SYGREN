...
func GetReleveData(w http.ResponseWriter, r *http.Request) {
	...
	// On garde l'ordre alphabétique des élèves (pour le numéro d'ordre) plutôt
	// que le classement — c'est ce que fait le document de référence.
	// Cependant, on conserve le rang dans le calcul des stats via `filtered`.
