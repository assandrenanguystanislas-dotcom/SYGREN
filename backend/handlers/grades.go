...
func UpsertGrade(w http.ResponseWriter, r *http.Request) {
	...
	// Fix E : recompute la moyenne précalculée de l'élève pour la session (sync).
	_ = recomputeStudentSessionResult(req.StudentID, req.SessionID)
...
func BulkUpsertGrades(w http.ResponseWriter, r *http.Request) {
	...
	// Fix E : recompute les moyennes précalculées pour la session (toutes les
	// notes de la session sont impactées — batch recompute).
	_ = recomputeSessionResults(req.SessionID)
...
func DeleteGrade(w http.ResponseWriter, r *http.Request) {
	...
	// Fix E : recompute la moyenne de l'élève (la note supprimée impacte sa moyenne).
	_ = recomputeStudentSessionResult(grade.StudentID, grade.SessionID)
