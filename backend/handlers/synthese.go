...
func GetSyntheseData(w http.ResponseWriter, r *http.Request) {
	...
	for _, l := range levels {
		totals.InscritsG += l.Inscrits[0]
		totals.InscritsF += l.Inscrits[1]
		totals.InscritsT += l.Inscrits[2]
		totals.PresentsG += l.Presents[0]
		totals.PresentsF += l.Presents[1]
		totals.PresentsT += l.Presents[2]
		totals.AdmisG += l.Admis[0]
		totals.AdmisF += l.Admis[1]
		totals.AdmisT += l.Admis[2]
	}
