        ...
        <CardContent className="py-4 flex items-start gap-3">
          ...
          <div className="text-sm space-y-1">
            ...
            <p className="text-muted-foreground text-xs leading-relaxed">
              ...
              élèves (matricule unique), adjoint(e)s au directeur et matières. Les statistiques
  ...
  switch (role) {
    ...
    case "inspector":
      return [
        ...
        { label: "Adjoint(e)s au directeur", value: String(d.teacherCount), hint: "comptes actifs", icon: <Users className="w-5 h-5" />, tone: "orange" },
      ];
    case "director":
      return [
        ...
        { label: "Adjoint(e)s au directeur", value: String(d.teacherCount), hint: "comptes actifs", icon: <Users className="w-5 h-5" />, tone: "neutral" },
    ...
    case "inspector":
      return [
        ...
        { label: "Adjoint(e)s au directeur", value: String(d.teacherCount), hint: "dans mon IEP", icon: <Users className="w-5 h-5" />, tone: "green" },
...
> = {
  ...
  director: [
    ...
    { label: "Gérer les adjoint(e)s au directeur", hint: "Comptes", view: "teachers", icon: <Users className="w-4 h-4" /> },
  ],
  inspector: [
    { label: "Gérer les IEP", hint: "Circonscriptions scolaires", view: "iep", icon: <BarChart3 className="w-4 h-4" /> },
    { label: "Gérer les écoles", hint: "Établissements", view: "schools", icon: <School className="w-4 h-4" /> },
